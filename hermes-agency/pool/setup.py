...
GROUPS = {
    'engineering': ['frontend-engineer', 'backend-engineer', 'fullstack-engineer', 'devops-engineer', 'infrastructure-engineer', 'database-engineer', 'data-engineer', 'integration-engineer', 'platform-engineer', 'tools-engineer', 'performance-engineer', 'automation-engineer', 'ai-engineer', 'godot-engineer', 'game-designer', 'level-designer', 'environment-artist', 'technical-artist'],
    'design': ['art-director', 'brand-designer', 'asset-artist', 'ui-ux-designer', 'creative-director', 'design-systems-designer', 'motion-designer', 'product-designer', 'worldbuilder', 'audio-designer'],
    'management': ['orchestrator', 'project-manager', 'product-manager', 'product-strategist', 'chief-of-staff', 'operations-manager', 'scrum-master', 'traffic-manager', 'launch-manager'],
    'content': ['copywriter', 'content-writer', 'technical-writer', 'docs-writer', 'dialogue-writer', 'scriptwriter', 'lore-writer', 'editor-in-chief', 'release-notes-writer'],
    'quality': ['qa-lead', 'qa-tester', 'code-reviewer', 'security-reviewer', 'compliance-reviewer', 'accessibility-reviewer', 'red-team', 'design-reviewer'],
    'security': ['security-engineer', 'security-reviewer', 'compliance-reviewer', 'red-team'],
    'research': ['competitive-analyst', 'market-researcher', 'user-researcher', 'analytics-specialist', 'business-analyst', 'requirements-analyst'],
    'marketing': ['marketing-strategist', 'growth-marketer', 'email-marketer', 'seo-specialist', 'social-media-manager', 'public-relations', 'community-manager'],
    'operations': ['devops-engineer', 'git-steward', 'release-manager', 'knowledge-manager', 'onboarding-specialist', 'training-specialist', 'support-specialist'],
    'business': ['finance-ops', 'legal-ops', 'procurement-specialist', 'partnerships-manager', 'customer-success', 'monetization-strategist']
}
