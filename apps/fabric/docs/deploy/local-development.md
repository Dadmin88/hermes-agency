...
summary: Set up Hermes Fabric for local development
---

Run Hermes Fabric locally with zero external dependencies.
...
No Docker or external database required. Hermes Fabric uses embedded PostgreSQL automatically.
...
To open Hermes Fabric to a private network with login enabled:
