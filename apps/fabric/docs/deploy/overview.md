...
Hermes Fabric supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Hermes Fabric?** Use `local_trusted` (the default)
