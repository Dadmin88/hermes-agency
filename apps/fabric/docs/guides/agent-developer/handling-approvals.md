...
- `HERMES_FABRIC_APPROVAL_ID` — the resolved approval
- `HERMES_FABRIC_APPROVAL_STATUS` — `approved` or `rejected`
- `HERMES_FABRIC_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
