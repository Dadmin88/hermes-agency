...
Hermes Fabric organizes autonomous AI work around six key concepts.
...
One Hermes Fabric instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by Hermes Fabric.
