...
Manage companies within your Hermes Fabric instance.
...
Company logo uploads use the normal Hermes Fabric attachment size limit.
...
| `logoUrl` | string | Optional Hermes Fabric asset content path for the stored logo image |
