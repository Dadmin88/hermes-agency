...
- Running a Python script that calls the Hermes Fabric API
...
1. Hermes Fabric spawns the configured command as a child process
2. Standard Hermes Fabric environment variables are injected (`HERMES_FABRIC_AGENT_ID`, `HERMES_FABRIC_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Hermes Fabric API and perform work.
