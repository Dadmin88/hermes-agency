...
name: design-guide
description: >
  Hermes Fabric UI design system guide for building consistent, reusable frontend
...
# Hermes Fabric Design Guide

Hermes Fabric's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Hermes Fabric-specific design language.
