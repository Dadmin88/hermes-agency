...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the Hermes Fabric heartbeat skill as the source of truth for the wake procedure.
...
When you wake up, follow the HermesFabric skill - it contains the full heartbeat procedure.
