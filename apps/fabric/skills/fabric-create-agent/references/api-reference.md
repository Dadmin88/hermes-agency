# Hermes Fabric Create Agent API Reference
...
- After approval resolution, requester may be woken with `HERMES_FABRIC_APPROVAL_ID` and should reconcile linked issues.
