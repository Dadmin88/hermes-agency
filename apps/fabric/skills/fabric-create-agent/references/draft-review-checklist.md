...
- [ ] The first paragraph points at the Hermes Fabric skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Hermes Fabric execution contract verbatim:
...
- [ ] Adapter config matches this Hermes Fabric instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
