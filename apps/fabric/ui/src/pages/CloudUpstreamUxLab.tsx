      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Push {selectedCompanyName} into a HermesFabric Cloud stack. Automations stay paused until activation.
          </p>
        </div>
        ...
        <div className="rounded-md border border-border px-4 py-4">
          {connection ? (
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto]">
              <Input
                defaultValue="https://fabric.fabric.app/PC521D/dashboard"
                placeholder="https://fabric.fabric.app/PC521D/dashboard"
                aria-label="HermesFabric Cloud stack URL"
                autoFocus
              />
              <Button disabled>
...
const STACK_TARGET = {
  ...
  stackSlug: "fabric-prod",
  stackDisplayName: "HermesFabric Prod",
  companyId: "co_4hT2yX",
  primaryHost: "fabric.fabric.app",
  origin: "https://fabric.fabric.app",
  product: "fabric-cloud",
  schemaMajor: 7,
...
function connectedConnection(target = STACK_TARGET): CloudUpstreamConnection {
  return {
    id: "cu_conn_8d3f1b6a",
    companyId: "co_4hT2yX",
    remoteUrl: "https://fabric.fabric.app/PC521D/dashboard",
    target,
...
function runningRun(): CloudUpstreamRun {
  return {
    ...
    targetUrl: "https://fabric.fabric.app/PC521D/dashboard",
    report: {},
    retryOfRunId: null,
...
function buildFixture(state: FixtureStateKey): Fixture {
  switch (state) {
    case "settings-pane":
      return {
        selectedCompanyName: "HermesFabric · PC521D",
