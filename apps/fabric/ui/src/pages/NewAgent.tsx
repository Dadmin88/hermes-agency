...
import { AGENT_ROLES, type AdapterEnvironmentTestResult, type AgentPermissions } from "@hermes-fabric/shared";
...
import { DEFAULT_OPENCODE_LOCAL_MODEL, isValidOpenCodeModelId } from "@hermes-fabric/adapter-opencode-local";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("hermes-fabric/fabric/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in HermesFabric runtime skills are added automatically.
              </p>
            </div>
