...
import type { Agent, Issue, IssueAttachment, IssueComment, IssueTreeControlPreview, IssueTreeHold, IssueWorkProduct } from "@hermes-fabric/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "Hermes Fabric", issuePrefix: "PAP", status: "active" }],
    selectedCompanyId: "company-1",
    selectedCompany: { id: "company-1", name: "Hermes Fabric", issuePrefix: "PAP", status: "active" },
...
describe("IssueDetail", () => {
  ...
  it("forwards composer work mode changes to the issues API", async () => {
    ...
    localStorage.setItem("fabric:issue-comment-draft:issue-1", "Draft follow-up message");
    ...
    expect(localStorage.getItem("fabric:issue-comment-draft:issue-1")).toBe("Draft follow-up message");
    expect(container.textContent).toContain("planning-notes.txt");
    localStorage.removeItem("fabric:issue-comment-draft:issue-1");
  });
