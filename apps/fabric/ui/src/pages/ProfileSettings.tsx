...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@hermes-fabric/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in HermesFabric file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into HermesFabric storage.";
