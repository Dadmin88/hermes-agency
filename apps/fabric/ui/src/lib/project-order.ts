...
export const PROJECT_ORDER_UPDATED_EVENT = "fabric:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "fabric:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "fabric.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "fabric.projectSortMode";
