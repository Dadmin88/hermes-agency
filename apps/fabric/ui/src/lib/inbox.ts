...
export const DISMISSED_KEY = "fabric:inbox:dismissed";
export const READ_ITEMS_KEY = "fabric:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "fabric:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "fabric:inbox:issue-columns";
export const INBOX_NESTING_KEY = "fabric:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "fabric:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "fabric:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "fabric:inbox:collapsed-groups";
