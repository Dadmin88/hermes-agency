...
import type { Agent, ExecutionWorkspace, Project, RoutineVariable } from "@hermes-fabric/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/fabric/project-1",
      effectiveLocalFolder: "/tmp/fabric/project-1",
