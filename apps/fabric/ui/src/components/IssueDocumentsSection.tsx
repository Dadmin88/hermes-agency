...
import { isSystemIssueDocumentKey } from "@hermes-fabric/shared";
...
const getFoldedDocumentsStorageKey = (issueId: string) => `fabric:issue-document-folds:${issueId}`;
...
export function IssueDocumentsSection({
  ...
  const documentBodyContentClassName = "fabric-edit-in-place-content min-h-[220px] text-[15px] leading-7";
