...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Hermes Fabric" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Hermes Fabric" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Hermes Fabric" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Hermes Fabric" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Hermes Fabric" },
