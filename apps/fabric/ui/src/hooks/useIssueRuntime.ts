...
export interface IssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface IssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: IssueRuntimeReassignment;
}

interface UseIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: IssueRuntimeSendOptions) => Promise<void>;
