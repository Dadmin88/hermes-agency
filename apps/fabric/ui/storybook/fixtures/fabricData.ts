...
const storybookRepoRoot = "~/fabric";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.fabric/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.fabric/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack HermesFabric product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make HermesFabric the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @hermes-fabric/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://fabric-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".fabric/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/fabricData.ts`.",
  ].join("\n"),
...
export const storybookSecretProviderDiscoveryPreview: SecretProviderConfigDiscoveryPreviewResult = {
  ...
  warnings: ["Skipped 1 HermesFabric-managed AWS secret from a different deployment namespace."],
  candidates: [
    {
      provider: "aws_secrets_manager",
      displayName: "AWS production",
      ...
      samples: [
        {
          name: "fabric/prod-use1/company-storybook/openai_api_key",
          hasKmsKey: true,
          tagKeys: ["fabric:managed-by", "fabric:environment", "fabric:provider-owner"],
        },
      ],
      signals: {
        namespace: "prod-use1",
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:fabric/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
...
export const storybookSecretBindings: CompanySecretBinding[] = [
  ...
  },
  {
    ...
    versionSelector: "latest",
    required: true,
    label: "HermesFabric App project env",
    createdAt: new Date("2026-03-02T09:00:00.000Z"),
    updatedAt: new Date("2026-03-02T09:00:00.000Z"),
  },
  {
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.hermes-fabric/instances/default/secrets/key separately from the database."],
    },
    {
