...
function StorybookGuide() {
  return (
    <div className="fabric-story">
      <main className="fabric-story__inner space-y-8">
        <section className="fabric-story__frame overflow-hidden p-6 sm:p-8">
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-3xl">
              <div className="fabric-story__label flex items-center gap-2">
                <BookOpen className="h-4 w-4" />
                HermesFabric Storybook
              </div>
              <h1 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
                Board UI stories for real control-plane states
              </h1>
              <p className="mt-4 text-sm leading-6 text-muted-foreground sm:text-base">
                This Storybook is organized as a review workspace for HermesFabric's operator UI: primitives first,
        ...
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {storyGroups.map((group) => {
            ...
            return (
              <Card key={group.title} className="fabric-story__frame shadow-none">
                <CardHeader>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "The overview story explains the local organization and the coverage contract for HermesFabric's Storybook.",
      },
    },
  },
