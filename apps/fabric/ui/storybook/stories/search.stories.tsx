...
import type { CompanySearchResult, CompanySearchResponse } from "@hermes-fabric/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/fabricData";
...
function SearchStories() {
  return (
    <div className="fabric-story">
      <main className="fabric-story__inner max-w-[1320px] space-y-6">
        <section className="fabric-story__frame p-6">
          <div className="fabric-story__label">Search</div>
        ...
        <section className="fabric-story__frame overflow-hidden">
          <div className="fabric-story__title-block">
            <div className="fabric-story__label">/search</div>
        ...
        <section className="fabric-story__frame overflow-hidden p-4">
          <div className="fabric-story__title-block">
            <div className="fabric-story__label">Match-source chips</div>
        ...
        <section className="fabric-story__frame overflow-hidden p-4">
          <div className="fabric-story__title-block">
            <div className="fabric-story__label">Cmd+K palette</div>
        ...
        <section className="fabric-story__frame overflow-hidden p-4">
          <div className="fabric-story__title-block">
            <div className="fabric-story__label">Search result row</div>
