...
import type { Goal, Project } from "@hermes-fabric/shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="fabric-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="fabric-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("fabric-worktree-enabled", "true");
  setWorktreeMeta("fabric-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("fabric-worktree-color", "#0f766e");
  setWorktreeMeta("fabric-worktree-text-color", "#ecfeff");
        ...
        <main className="fabric-story__inner space-y-6">
          <section className="fabric-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="fabric-story__label">Projects, goals, and workspaces</div>
