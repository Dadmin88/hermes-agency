        ...
        <main className="fabric-story__inner space-y-6">
          <section className="fabric-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="fabric-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="fabric-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="fabric-story">
        <main className="fabric-story__inner space-y-6">
          <section className="fabric-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="fabric-story__label">IssueRunLedger</div>
