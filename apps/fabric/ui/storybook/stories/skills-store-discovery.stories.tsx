...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "hermes-fabric/fabric/fabric-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "fabric-dev",
    slug: "fabric-dev",
    ...
    version: "v2.4.1",
    tagline: "Run and repair local HermesFabric workspaces.",
    description: "Develop and operate a local HermesFabric instance.",
  ...
  {
    key: "hermes-fabric/fabric/verify",
    skillId: "s-verify",
    catalogRef: null,
    name: "verify",
    slug: "verify",
  ...
  {
    key: "hermes-fabric/fabric/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "hermes-fabric/fabric/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",
