...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@hermes-fabric/shared";
...
import { createIssue, storybookAgents } from "../fixtures/fabricData";
...
function Section({
  ...
  return (
    <section className="fabric-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="fabric-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="fabric-story">
      <main className="fabric-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/DeployFaith/Hermes_Agency).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active HermesFabric secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @hermes-fabric/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "hermes-fabric/fabric",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building HermesFabric" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    defaultRef: "master",
    repoName: "fabric",
    localFolder: "/Users/dotta/fabric",
    managedFolder: "fabric",
    effectiveLocalFolder: "/Users/dotta/fabric",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="fabric-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="fabric-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">HermesFabric form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for HermesFabric form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
