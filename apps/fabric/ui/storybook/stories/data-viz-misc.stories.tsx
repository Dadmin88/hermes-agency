...
import type { HeartbeatRun, Issue } from "@hermes-fabric/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "HermesFabric Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII fabric field"}>
