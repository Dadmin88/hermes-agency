...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@hermes-fabric/shared";
import type {
...
import { createIssue } from "../fixtures/fabricData";
    ...
    <div className="fabric-story">
      <main className="fabric-story__inner space-y-6">
        <section className="fabric-story__frame p-6">
          <div className="fabric-story__label">Language</div>
