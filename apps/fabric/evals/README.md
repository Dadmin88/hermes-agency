...
Eval framework for testing Hermes Fabric agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Hermes Fabric heartbeat skill:
