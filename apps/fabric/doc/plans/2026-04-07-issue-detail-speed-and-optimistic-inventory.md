...
This note inventories the Hermes Fabric issues that point to the same UX class of problem:
...
Pattern: Hermes Fabric already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
