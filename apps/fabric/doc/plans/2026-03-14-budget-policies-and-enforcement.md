...
Hermes Fabric already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Hermes Fabric should implement next.

## Product Goals

Hermes Fabric should let operators:
...
For the next implementation pass, Hermes Fabric should enforce these defaults:
...
Hermes Fabric should separate subscription-included usage from billed spend:
...
Hermes Fabric should have two threshold classes:
...
Hermes Fabric must know that a project is budget-paused and enforce it.
...
Hermes Fabric must also block execution before new work starts.
