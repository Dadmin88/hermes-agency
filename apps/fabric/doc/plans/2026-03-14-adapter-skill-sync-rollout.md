...
This document defines the rollout plan for adapter-wide skill support in Hermes Fabric.
...
- Hermes Fabric stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

Hermes Fabric currently has these adapters:
...
1. Desired skills live in Hermes Fabric for every adapter.
...
These adapters have a stable local skills directory that Hermes Fabric can read and manage.
...
These adapters do not have a meaningful Hermes Fabric-owned persistent install state.
...
- show desired Hermes Fabric skills
...
- desired skills are stored in Hermes Fabric
...
- desired skills stored in Hermes Fabric
...
- Hermes Fabric reconciles desired skills into `~/.cursor/skills`
...
- Hermes Fabric reconciles desired skills into `~/.gemini/skills`
...
- Hermes Fabric reconciles desired skills into `~/.pi/agent/skills`
...
- Hermes Fabric can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects Hermes Fabric skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- Hermes Fabric may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed Hermes Fabric skills that are clearly marked as Hermes Fabric-managed
...
- Hermes Fabric stores desired skills only
...
- avoid destructive wording unless Hermes Fabric can prove a skill is Hermes Fabric-managed
