...
- installed adapter list for this Hermes Fabric instance
...
## 8. New Skill: `fabric-create-agent`

Create new skill directory:

- `skills/fabric-create-agent/SKILL.md`
- `skills/fabric-create-agent/references/api-reference.md`
...
Also update `skills/fabric/SKILL.md` to reference this skill for hiring workflows.
...
- `fabric-create-agent` skill + docs updates
