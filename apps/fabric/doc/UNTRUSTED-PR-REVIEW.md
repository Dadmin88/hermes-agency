...
This is intentionally separate from the normal Hermes Fabric dev image.
...
```sh
review-checkout-pr hermes-fabric/fabric 432
cd /work/checkouts/hermes-fabric-fabric/pr-432
```
...
## Preview the Hermes Fabric app from the PR
...
- Hermes Fabric's embedded PostgreSQL and local storage stay inside the container home volume via `HERMES_FABRIC_HOME=/home/reviewer/.fabric-review`.
