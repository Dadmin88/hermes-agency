 ...
 *
 * Opt-in mechanism: a line containing `fabric:allow-git-push` (typically
 * inside a `// fabric:allow-git-push: <reason>` comment on the line itself
...
export const ALLOW_MARKER = "fabric:allow-git-push";
