...
HERMES_FABRIC_API_KEY="fabric-secret"
HERMES_FABRIC_AUTH_HEADER="Bearer board-secret"
HERMES_FABRIC_COOKIE="session=board-cookie"
output="$(redact_text "gateway-secret claim-secret agent-secret fabric-secret Bearer board-secret session=board-cookie")"
[[ "$output" != *"gateway-secret"* ]]
[[ "$output" != *"claim-secret"* ]]
[[ "$output" != *"agent-secret"* ]]
[[ "$output" != *"fabric-secret"* ]]
[[ "$output" != *"board-secret"* ]]
[[ "$output" != *"board-cookie"* ]]
