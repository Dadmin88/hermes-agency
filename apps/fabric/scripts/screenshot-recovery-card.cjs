...
const STORIES = [
  {
    id: "fabric-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "fabric-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "fabric-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "fabric-source-issue-recovery--active-run-panel-recovery-chips",
