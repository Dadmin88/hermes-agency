...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" fabric doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `hermes-fabric configure --section database` or `hermes-fabric onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadHermesFabricEnvFile(input.configPath);
