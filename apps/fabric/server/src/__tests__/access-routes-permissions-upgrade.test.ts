...
vi.hoisted(() => {
  process.env.HERMES_FABRIC_HOME = "/tmp/fabric-test-home";
  process.env.HERMES_FABRIC_INSTANCE_ID = "vitest";
  process.env.HERMES_FABRIC_LOG_DIR = "/tmp/fabric-test-home/logs";
  process.env.HERMES_FABRIC_IN_WORKTREE = "false";
});
...
describeEmbeddedPostgres("access routes permissions upgrade compatibility", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("fabric-access-routes-permissions-upgrade-");
