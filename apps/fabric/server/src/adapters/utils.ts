...
import * as serverUtils from "@hermes-fabric/adapter-utils/server-utils";
export type { RunProcessResult } from "@hermes-fabric/adapter-utils/server-utils";
...
export const buildHermesFabricEnv = serverUtils.buildHermesFabricEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "HERMES_FABRIC_RESOLVED_COMMAND"] =
