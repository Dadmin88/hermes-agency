 ...
 */
import type { CompanyPortabilityManifest } from "@hermes-fabric/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [HermesFabric](https://fabric.ing)");
  lines.push("");
