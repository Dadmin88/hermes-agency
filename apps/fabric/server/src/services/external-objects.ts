...
import { documents, externalObjectMentions, externalObjects, issueComments, issueDocuments, issues, plugins } from "@hermes-fabric/db";
import {
  ...
  type HermesFabricPluginManifestV1,
} from "@hermes-fabric/shared";
import { extractExternalObjectCanonicalUrls } from "@hermes-fabric/shared/external-objects-server";
import type { PluginExternalObjectRecordSnapshot, PluginExternalObjectResolveResult } from "@hermes-fabric/plugin-sdk";
