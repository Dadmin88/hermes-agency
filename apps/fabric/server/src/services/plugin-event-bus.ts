/**
 * PluginEventBus — typed in-process event bus for the HermesFabric plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@hermes-fabric/shared";
import type { PluginEvent, EventFilter } from "@hermes-fabric/plugin-sdk";
