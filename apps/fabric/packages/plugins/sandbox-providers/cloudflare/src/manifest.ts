...
const PLUGIN_ID = "fabric.cloudflare-sandbox-provider";
  ...
  environmentDrivers: [
    {
      ...
      description:
        "Runs HermesFabric sandbox environments through a Cloudflare Worker bridge backed by the Sandbox SDK and Durable Objects.",
      configSchema: {
        type: "object",
        properties: {
          bridgeBaseUrl: {
