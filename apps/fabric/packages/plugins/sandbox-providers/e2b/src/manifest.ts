...
const PLUGIN_ID = "fabric.e2b-sandbox-provider";
...
const manifest: HermesFabricPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions E2B cloud sandboxes as HermesFabric execution environments.",
      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific E2B API key. Paste a key or an existing HermesFabric secret reference; saved environments store pasted values as company secrets. Falls back to E2B_API_KEY if omitted.",
          },
          timeoutMs: {
            type: "number",
            description:
