import type { PluginLauncherRegistration } from "@hermes-fabric/plugin-sdk";

export const PLUGIN_ID = "fabric-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".fabric-kitchen-sink-demo.txt",
} as const;
