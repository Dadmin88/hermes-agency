...
const PLUGIN_ID = "fabric.fake-sandbox-provider";
...
const manifest: HermesFabricPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising HermesFabric provider-plugin integration without external infrastructure.",
