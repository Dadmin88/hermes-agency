/**
 * `definePlugin` — the top-level helper for authoring a HermesFabric plugin.
 *
...
export interface PluginDefinition {
  ...
  /**
   * Called when HermesFabric scans issue/comment/document content and asks this
  ...
  /**
   * Called when HermesFabric needs the current normalized status for one external
...
// ---------------------------------------------------------------------------
// HermesFabricPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface HermesFabricPlugin {
 ...
 * @returns A sealed `HermesFabricPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@hermes-fabric/plugin-sdk";
