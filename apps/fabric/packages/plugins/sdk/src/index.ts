/**
 * `@hermes-fabric/plugin-sdk` — HermesFabric plugin worker-side SDK.
 *
 * This is the main entrypoint for plugin worker code.  For plugin UI bundles,
 * import from `@hermes-fabric/plugin-sdk/ui` instead.
 *
 * @example
 * ```ts
 * // Plugin worker entrypoint (dist/worker.ts)
 * import { definePlugin, runWorker, z } from "@hermes-fabric/plugin-sdk";
 *
...
// Manifest and constant types re-exported from @hermes-fabric/shared
// Plugin authors import manifest types from here so they have a single
// dependency (@hermes-fabric/plugin-sdk) for all plugin authoring needs.
export type {
 ...
 * @example
 * ```ts
 * import { z } from "@hermes-fabric/plugin-sdk";
 *
