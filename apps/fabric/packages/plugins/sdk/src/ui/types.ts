/**
 * HermesFabric plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@hermes-fabric/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed HermesFabric navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a HermesFabric-internal path using the active company prefix.
   *
