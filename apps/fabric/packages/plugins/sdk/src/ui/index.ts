/**
 * `@hermes-fabric/plugin-sdk/ui` — HermesFabric plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@hermes-fabric/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@hermes-fabric/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate HermesFabric-internal links through the host router
