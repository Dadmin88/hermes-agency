/**
 * Bundling presets for HermesFabric plugins.
 *
 ...
 * to match the HermesFabric plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@hermes-fabric/plugin-sdk/ui",
    "@hermes-fabric/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node20",
    sourcemap,
    external: ["@hermes-fabric/plugin-sdk"],
  };
