...
The hero capsule bank is the one approved decorative exception to the rule that capsules represent individual agents. It is a canonical Hermes Fabric brand surface. Do not improvise a different capsule bank.

## Source Precedence

1. `fabric-content/td/capsules.md` - byte-accurate technical source for geometry, gradients, grain, crop, and wave.
2. Hermes Fabric feature-video HyperFrames skill:
   - `references/capsule-bank-spec.md`
   - `references/brand-tokens.md`
   - `references/composition-recipes.md`
3. `fabric-content/videos/wireframe-skill-launch/src/HeroCapsuleBank.tsx` - working Remotion implementation.
