...
Use this reference when generating or reviewing deterministic Hermes Fabric capsule identicons/profile pills. Prototype source paths, when the Hermes Fabric content repository is available:

- `fabric-content/design/PAP-11825/fabric-capsule-identicon-prototyper/README.md`
- `fabric-content/design/PAP-11825/fabric-capsule-identicon-prototyper/src/identicon.ts`
- `fabric-content/design/PAP-11825/fabric-capsule-identicon-prototyper/src/App.tsx`
