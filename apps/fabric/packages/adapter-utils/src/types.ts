...
export interface AdapterEnvironmentTestContext {
   ...
   *
   * If omitted (or `kind === "local"`), the adapter tests on the HermesFabric
...
export interface AdapterRuntimeCommandSpec {
  /**
   * The command HermesFabric should execute for this adapter in the current config.
   */
  command: string;
  /**
...
export interface ServerAdapterModule {
   ...
   * rather than reading config.fabricRuntimeSkills.
   */
