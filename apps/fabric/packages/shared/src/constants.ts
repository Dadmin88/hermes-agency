...
export const SECRET_MANAGED_MODES = ["fabric_managed", "external_reference"] as const;
 ...
 * HermesFabric UI where plugin components can be rendered.
 *
