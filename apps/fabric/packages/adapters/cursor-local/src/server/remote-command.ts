...
import { ensurePathInEnv } from "@hermes-fabric/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__HERMES_FABRIC_CURSOR_HOME__:";
  const preferredMarker = "__HERMES_FABRIC_CURSOR_AGENT__:";
  try {
