...
const helperPath = path.resolve(__dirname, "../../skills/fabric-task-bridge/fabric-task.mjs");
...
describe("fabric-task-bridge helper", () => {
  ...
  function env() {
    return {
      HERMES_FABRIC_API_URL: baseUrl,
      HERMES_FABRIC_BRIDGE_API_KEY: apiKey,
      HERMES_FABRIC_COMPANY_ID: "22222222-2222-4222-8222-222222222222",
      HERMES_FABRIC_AGENT_ID: "11111111-1111-4111-8111-111111111111",
      HERMES_FABRIC_RUN_ID: "66666666-6666-4666-8666-666666666666",
    };
  }
  ...
  it("creates tasks assigned to the authenticated agent by default", async () => {
    ...
    expect(createRequest?.headers["x-fabric-run-id"]).toBe("66666666-6666-4666-8666-666666666666");
