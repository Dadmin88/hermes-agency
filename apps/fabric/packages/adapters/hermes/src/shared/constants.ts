...
/** Adapter type identifier registered with HermesFabric. */
export const ADAPTER_TYPE = "hermes_local";

/** Human-readable label shown in the HermesFabric UI. */
 ...
 * hardcoded Anthropic model during HermesFabric onboarding.
 */
