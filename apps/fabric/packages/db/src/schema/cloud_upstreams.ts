...
export const cloudUpstreamRuns = pgTable(
  "cloud_upstream_runs",
  {
    ...
    summary: jsonb("summary").$type<import("@hermes-fabric/shared").CloudUpstreamSummaryCount[]>().notNull().default([]),
    warnings: jsonb("warnings").$type<import("@hermes-fabric/shared").CloudUpstreamWarning[]>().notNull().default([]),
    conflicts: jsonb("conflicts").$type<import("@hermes-fabric/shared").CloudUpstreamConflict[]>().notNull().default([]),
    events: jsonb("events").$type<import("@hermes-fabric/shared").CloudUpstreamRunEvent[]>().notNull().default([]),
