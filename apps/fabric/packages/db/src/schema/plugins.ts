...
import type { PluginCategory, PluginStatus, HermesFabricPluginManifestV1 } from "@hermes-fabric/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<HermesFabricPluginManifestV1>().notNull(),
