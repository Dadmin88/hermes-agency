...
class TaskTimeoutError(TimeoutError):
    """Raised when a task wait exceeds the requested timeout."""


class TaskFailedError(RuntimeError):
    """Raised when a task reaches the failed state."""


class TaskCanceledError(RuntimeError):
    """Raised when a task reaches the canceled state."""


class TaskRejectedError(RuntimeError):
    """Raised when a task reaches the rejected state."""
