# AgentAnycast Python Changelog

This file preserves the historical release notes for the legacy AgentAnycast Python SDK vendored under `src/agentanycast/`. Hermes Agency product changes are documented in the repository-root `CHANGELOG.md`.

The format is based on [Keep a Changelog](https://keepachangelog.com/), and the upstream SDK used [Semantic Versioning](https://semver.org/).
...
- LangGraph adapter (`agentanycast[langgraph]`) — serve compiled graphs to P2P agents
