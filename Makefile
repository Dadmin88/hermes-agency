...
test-agency:
	$(PYTEST) hermes-agency/tests/test_unit.py hermes-agency/tests/test_model_sets.py hermes-agency/tests/test_extended_status_discord.py -q -m "not integration"
